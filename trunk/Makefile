...
INCLUDES=-I$(PROJ_DIR)/include \
	...
	-I$(PROJ_DIR)/src/elliptic -I$(PROJ_DIR)/src/hyperbolic -I$(PROJ_DIR)/src/high-order \
...
SRC_DIR3=$(PROJ_DIR)/src/high-order
...
OBJS1=$(OBJ_DIR)/main.o $(OBJ_DIR)/SIMULATION_core.o $(OBJ_DIR)/SIMULATION_core__solvers.o \
	...
	$(OBJ_DIR)/HighOrderApproximation.o $(OBJ_DIR)/SaturationGradient.o $(OBJ_DIR)/SL__Woodfield.o $(OBJ_DIR)/SL__MUSCL.o \
    ...
    $(OBJ_DIR)/Exception.o $(OBJ_DIR)/exportVTK.o $(OBJ_DIR)/PhysicPropData.o $(OBJ_DIR)/GeomData.o $(OBJ_DIR)/LoadSimulatorParameters.o
...
OBJS2=$(OBJ_DIR)/CalculateDegreeOfRefinement_2D.o $(OBJ_DIR)/AdaptiveRemeshing.o \
    ...
    $(OBJ_DIR)/UnevenElements.o $(OBJ_DIR)/IhR_main.o $(OBJ_DIR)/interpolation.o $(OBJ_DIR)/IAR_main.o \
