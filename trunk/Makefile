...
INCLUDES=-I$(APP_DIR)/FMDB-2011/include \
	...
	-I$(PROJ_DIR)/src/adaptation/adaptive-remeshing \
	...
	-I$(GMSH_DIR)/Plugin \
	-I$(GMSH_DIR)/Post \
 	-I$(PROJ_DIR)/src/adaptation/rh-refinement \
 	-I$(APP_DIR)/MAdLib_no_gmsh/include \
	-I$(APP_DIR)/autopack/include
	
# paths for libraries
# ===================
LIBS=-L$(APP_DIR)/FMDB-2011/lib -lFMDB-O \
     -L$(APP_DIR)/gmshGMSH/lib -lGmsh \
     -L$(APP_DIR)/ParMetis-3.1/lib -lparmetis -lmetis \
     -L$(APP_DIR)/autopack/lib -lautopack-O

#     -L$(APP_DIR)/MAdLib_no_gmsh/lib/Contrib -lautopack \
#     -L$(APP_DIR)/MAdLib_no_gmsh/lib -lMAdLib \
...
OBJECTS=$(OBJ_DIR)/main.o $(OBJ_DIR)/auxiliar.o $(OBJ_DIR)/SimulatorParameters.o \
	...
	$(OBJ_DIR)/EBFV1_advanceSaturation.o $(OBJ_DIR)/OilProductionManagement.o \
    ...
    $(OBJ_DIR)/CalculateDegreeOfRefinement_2D.o $(OBJ_DIR)/AdaptiveRemeshing.o \
    ...
    $(OBJ_DIR)/EBFV1_preprocessor.o $(OBJ_DIR)/IhR_main.o $(OBJ_DIR)/interpolation.o $(OBJ_DIR)/IAR_main.o \
