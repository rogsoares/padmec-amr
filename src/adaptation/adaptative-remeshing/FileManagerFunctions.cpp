...
void FileManagerFunctions::CreateLineLoop(set<pEdge> CommonEdges, int c, string FileName, pMesh theMesh) { // "recebe" um set de Edges e cria uma matriz nx3 O set é o BEdges tantas vezes quantas forem necessárias
